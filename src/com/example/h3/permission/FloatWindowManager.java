 ...
 */
package com.example.h3.permission;
...
import com.example.h3.permission.rom.HuaweiUtils;
import com.example.h3.permission.rom.MeizuUtils;
import com.example.h3.permission.rom.MiuiUtils;
import com.example.h3.permission.rom.QikuUtils;
import com.example.h3.permission.rom.RomUtils;
...
public class FloatWindowManager {
    ...
    public boolean applyOrShowFloatWindow(Context context) {
        if (checkPermission(context)) {
            //showWindow(context);
        	//Toast.makeText(context, "已授予悬浮窗权限！", Toast.LENGTH_LONG).show();
        	return true;
        } else {
        	String say="请找到悬浮窗选项，然后打开！";
        	SpeechUtil.getSpeechUtil(context).speak(say);

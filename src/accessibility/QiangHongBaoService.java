...
public class QiangHongBaoService extends AccessibilityService {
	...
	public void onCreate() {
		...
		Log.d(Config.TAG, "qianghongbao service onCreate");
	}
    ...
    public void onInterrupt() {
    	Log.d(Config.TAG, "qianghongbao service interrupt");
    ...
    protected void onServiceConnected() {
        ...
        if(mIsWorkDoneByHand){
        	...
        	Intent intent = new Intent(Config.ACTION_QIANGHONGBAO_SERVICE_CONNECT); //发送广播，已经连接上了
        	sendBroadcast(intent); 
        }
        mIsWorkDoneByHand=false;
        Log.d(Config.TAG, "qianghongbao service onServiceConnected");
    }
	@Override
    ...
    public static void sendRequsetPermissionBroadCast(Context context) {
    	...
    	String servicename=context.getString(ResourceUtil.getStringId(context, "service_name"));
    	String description=context.getString(ResourceUtil.getStringId(context, "accessibility_description"));

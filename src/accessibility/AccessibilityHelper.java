...
public class AccessibilityHelper {
	...
	public static void recycle(AccessibilityNodeInfo info) {
  		if (info.getChildCount() == 0) {
  			...
  			Log.i(Config.TAG, "ResouceId:" + info.getViewIdResourceName());
  			Log.i(Config.TAG, "isClickable:" + info.isClickable());
  			Log.i(Config.TAG, "isCheckable:" + info.isCheckable());
  			Log.i(Config.TAG, "isChecked:" + info.isChecked());
  			Rect outBounds=new Rect();
  			info.getBoundsInScreen(outBounds);
  			Log.i(Config.TAG, "outBounds:" + outBounds);
  			Log.i(Config.TAG, "isFocusable:" + info.isFocusable());
  			Log.i(Config.TAG, "isAccessibilityFocused:" + info.isAccessibilityFocused());
  			Log.i(Config.TAG, "isFocused:" + info.isFocused());
